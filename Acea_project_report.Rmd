...
# Measure Accuracy
submodel_calibrate_tbl %>% modeltime_accuracy() kable('latex', digits = 10, caption = 'Data summary table', booktabs = T) %>% kable_styling(full_width = FALSE, font_size = 11, latex_options = c("striped", 'condensed','scale_down')) %>% column_spec(3, width = "12em")

submodel_calibrate_tbl_SAL %>% modeltime_accuracy() kable('latex', digits = 10, caption = 'Data summary table', booktabs = T) %>% kable_styling(full_width = FALSE, font_size = 11, latex_options = c("striped", 'condensed','scale_down')) %>% column_spec(3, width = "12em")
````
